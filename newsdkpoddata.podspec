...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of newsdkpoddata.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mobileexpert1/newsdkpoddata'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mobileexpert1' => 'appsdev096@gmail.com' }
  s.source           = { :git => 'https://github.com/mobileexpert1/newsdkpoddata.git', :tag => s.version.to_s }
